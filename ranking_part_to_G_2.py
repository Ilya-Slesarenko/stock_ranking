...
class RankingClass():
    ...
    def spreadsheet_forming(self):
        ...
        print(f'All dataset is parsed, getting start with the rest...')
        ...
        # Дропнуть лишние столбцы!

        updated_results_df_res_1 = pd.DataFrame(rank_sheet_values_updated,columns=rank_head)
